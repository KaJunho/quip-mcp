...
class QuipClient(object):
    ...
    def add_thread_members_by_access_level(self, thread_id, member_ids_by_access_level):
        """Adds user IDs with different access levels to the given thread.
            {
            ...
            pass member_ids_by_access_level as a python list
        """
        return self._fetch_json("threads/add-members", post_data={
            "thread_id": thread_id,
            "member_ids_by_access_level": json.dumps(member_ids_by_access_level),
        })
